...
var (
	...
	grpcServer *grpcserver.HomeClusterProviderServer
)
...
var _ = BeforeSuite(func() {
	...
	var err error
	err = infrahomeclusterdevv1alpha1.AddToScheme(scheme.Scheme)
	...
	By("initializing gRPC server for integration tests")
	grpcServer = grpcserver.NewHomeClusterProviderServer(k8sClient, scheme.Scheme)
